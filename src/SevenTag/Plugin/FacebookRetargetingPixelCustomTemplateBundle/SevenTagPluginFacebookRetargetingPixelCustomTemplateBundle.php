...
/**
 * Class SevenTagPluginFacebookRetargetingPixelCustomTemplateBundle
 * @package SevenTag\Plugin\FacebookRetargetingPixelCustomTemplateBundle
 */
class SevenTagPluginFacebookRetargetingPixelCustomTemplateBundle extends PluginAwareBundle
{
}
