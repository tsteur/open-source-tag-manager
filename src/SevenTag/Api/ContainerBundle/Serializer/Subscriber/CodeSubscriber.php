...
class CodeSubscriber implements EventSubscriberInterface
{
     ...
     * @var CodeProviderInterface
     */
    private $synchronousSnippetProvider;

    /**
     * @param CodeProviderInterface $snippetProvider
     * @param CodeProviderInterface $syncSnippetProvider
     */
    public function __construct(CodeProviderInterface $snippetProvider, CodeProviderInterface $syncSnippetProvider)
    {
        $this->snippetProvider = $snippetProvider;
        $this->synchronousSnippetProvider = $syncSnippetProvider;
    }
    ...
    public function addCodeToContainer(ObjectEvent $event)
    {
        ...
        if ($container instanceof ContainerInterface) {
            ...
            $container->setCodeSynchronous($this->synchronousSnippetProvider->getCode($container));
        }
    }
}
